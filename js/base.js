base = {
    ...
    default_infowindow_template : '<div class="infoWindow"><h3>My {{title}}</h3>{{street}}<br/>{{city}}, {{state}} {{zip}}<br/>{{phone}}<br/><a href="{{url}}">{{url}}</a></div>',
